...
Mass of the heaviest neutrino generation in a supereasy linear response.
If set to zero, degenerate hierarchy is assumed, and mass will be calculated
from the OmegaNu parameter. No internal checks exist if this non-degenerate
hierarchy is used. The user is responsible for making sure the masses correspond
to the OmegaNu parameter set.

-------

**m_nu2**  0.0

Mass of the second neutrino generation.

-------

**m_nu3**  0.0

Mass of the third neutrino generation. 
